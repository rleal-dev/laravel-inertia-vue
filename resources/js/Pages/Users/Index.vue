    ...
    <AuthenticatedLayout v-bind="{breadcrumbs}">
        ...
        <div class="py-8">
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <AlertSuccess :message="$page.props.flash.success" @close="router.reload()" />
                    <AlertError :message="$page.props.flash.error" @close="router.reload()" />
                                ...
                                <div class="border dark:border-gray-700 rounded-lg divide-y divide-gray-200 dark:divide-gray-700">
                                    <div class="flex justify-between py-3 px-4 bg-white dark:bg-gray-800">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 dark:text-gray-300 cursor-pointer" @click="openFilter">
        ...
        <FilterList :show="showFilter" @close="showFilter = false">
            <div class="p-2">
                ...
                <button @click="searchUsers" class="w-full inline-flex justify-center px-4 py-3 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                    {{ __('common.search') }}
                </button>
            </div>
        </FilterList>
