...
<template>
    <div class="relative max-w-xs md:max-w-xl md:w-full">
        ...
        <div class="relative flex rounded-lg shadow-sm">
            <input v-model="model" @keyup.enter="($event) => emit('search')" type="text" class="py-2 px-3 ps-9 block w-full border-gray-200 dark:border-gray-600 shadow-sm rounded-s-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:text-gray-200" :placeholder="__('common.search')">
